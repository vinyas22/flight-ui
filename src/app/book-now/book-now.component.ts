...
const modalElement = document.getElementById('loading');
  ...
  modal.show(); 
    ...
    this.http.post(
  `https://flight-api-4urq.onrender.com/api/flights/payment/generate-otp`,
...
if (this.currentModal) {
  ...
  confirmPayment() {
    ...
    this.http.post('https://flight-api-4urq.onrender.com/api/flights/payment/confirm', payload,{responseType: 'text'})
      .subscribe({
        next: () => {
